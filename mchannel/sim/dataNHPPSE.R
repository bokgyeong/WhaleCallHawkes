...
beta0 = round(colMeans(postBeta0[-(1:burn),]), 2) + 1
...
trpar = list(beta00 = beta00, tau = tau, beta0 = beta0, beta = beta,
...
lam0 = compLam0(ts, marks, maxT, trpar$beta0, Xm, trpar$beta, trpar$delta, rep(0,m+1), indlam0, knts)
intLam0 = compIntLam0(maxT, trpar$beta0, Xm, trpar$beta, trpar$delta, rep(0,m+1)) 
# par(mfrow = c(2,3))
# for(i in 1:K){
